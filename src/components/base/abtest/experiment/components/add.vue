  ...
  <div class="box">
    ...
    <el-form style="margin-top:20px" ref="form" :rules="rules" :model="form" label-width="80px">
      ...
      <el-form-item prop="experimentKey" label="key">
        <el-input v-model="form.experimentKey" style="width:400px"></el-input>
      </el-form-item>
      ...
      <el-form-item prop="productId" label="产品">
        <el-select :loading="proLoading" filterable v-model="form.productId">
          <el-option
...
export default {
  ...
  methods: {
    ...
    async handlerRun() {
      this.loading = true;
      const res = await this.$base.addExperiment(ObjToFormData(this.form));
      this.loading = false;
      if (res) {
        this.$message({
          type: "success",
