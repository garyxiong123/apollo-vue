...
<script>
  ...
  import TreeStore2 from './model/tree-store';
  ...
  export default {
    ...
    watch: {
      ...
      defaultCheckedKeys2(newVal){
        this.store2.defaultCheckedKeys = newVal;
        this.store2.setDefaultCheckedKey(newVal);
      },
    ...
    methods: {
      ...
      getCheckedNodes2(leafOnly) {
        return this.store2.getCheckedNodes(leafOnly);
      },
      ...
      getCheckedKeys2(leafOnly) {
        return this.store2.getCheckedKeys(leafOnly);
      },
      ...
      setCheckedKeys2(keys, leafOnly) {
        if (!this.nodeKey) throw new Error('[Tree] nodeKey is required in setCheckedKeys');
        this.store2.setCheckedKeys(keys, leafOnly);
      },
      ...
      getHalfCheckedKeys2() {
        return this.store2.getHalfCheckedKeys();
      },
    ...
    created() {
      ...
      this.store2 = new TreeStore2({
        ...
        checkStrictly: this.checkStrictly,
        checkDescendants: this.checkDescendants,
        defaultCheckedKeys: this.defaultCheckedKeys2,
        defaultExpandedKeys: this.defaultExpandedKeys,
        autoExpandParent: this.autoExpandParent,
        defaultExpandAll: this.defaultExpandAll,
        filterNodeMethod: this.filterNodeMethod
