<template>
  <article class="login-box">
    ...
    <section @keydown.enter="enterLogin" class="login-body">
      <div class="desc-box">
      ...
      <el-tabs v-loading="qrLoading" element-loading-text="正在登陆中,请稍后" class="login-form-box" v-model="loginType" type="card">
        <el-tab-pane label="密码登陆" name="password">
          <el-form style="padding:0 20px;margin-top:40px" :model="loginForm" status-icon>
            <el-form-item class="form-item">
              <el-input v-model="loginForm.username" clearable placeholder="请输入用户名" auto-complete="off" @change="inputVal">
                <i slot="prefix" class="iconfont icon-01"></i>
              </el-input>
            </el-form-item>
            <el-form-item class="form-item">
              <el-input type="password" v-model="loginForm.password" clearable placeholder="请输入密码" auto-complete="off" @input="inputVal">
              ...
              <el-form-item class="form-item">
              <el-button v-loading="loading" class="login-btn" type="primary" @click="login" :disabled="!canLogin">登录</el-button>
              </el-form-item>
          </el-form>
        </el-tab-pane>
      </el-tabs>
